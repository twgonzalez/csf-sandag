...
def write() -> dict:
    ...
    add("them: both satisfy the same RHNA obligation. The bedroom mix of what actually gets")
    add("built is decided by local zoning, inclusionary standards, and housing-element")
    add("programs — the one layer of this problem the region's cities still fully control.")
